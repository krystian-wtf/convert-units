...
var Converter = /** @class */ (function () {
    ...
    Converter.prototype.to = function (to) {
        ...
        if (destination.measure != origin.measure) {
            throw new Error("Cannot convert incompatible measures of ".concat(destination.measure, " and ").concat(origin.measure));
        }
        /**
        ...
        if (origin.system != destination.system) {
            ...
            if (anchors == null) {
                throw new Error("Unable to convert units. Anchors are missing for \"".concat(origin.measure, "\" and \"").concat(destination.measure, "\" measures."));
            }
            var anchor = anchors[origin.system];
            if (anchor == null) {
                throw new Error("Unable to find anchor for \"".concat(origin.measure, "\" to \"").concat(destination.measure, "\". Please make sure it is defined."));
            }
    ...
    Converter.prototype.list = function (measureName) {
        ...
        if (measureName == null) {
            ...
            throw new Error("Meausre \"".concat(measureName, "\" not found."));
        }
        else {
    ...
    Converter.prototype.throwUnsupportedUnitError = function (what) {
        ...
        throw new Error("Unsupported unit ".concat(what, ", use one of: ").concat(validUnits.join(', ')));
    };
    /**

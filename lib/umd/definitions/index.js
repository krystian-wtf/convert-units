...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./acceleration", "./angle", "./apparentPower", "./area", "./charge", "./current", "./digital", "./each", "./energy", "./force", "./frequency", "./illuminance", "./length", "./mass", "./pace", "./partsPer", "./pieces", "./power", "./pressure", "./reactiveEnergy", "./reactivePower", "./speed", "./temperature", "./time", "./torque", "./voltage", "./volume", "./volumeFlowRate"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.volumeFlowRate = exports.volume = exports.voltage = exports.torque = exports.time = exports.temperature = exports.speed = exports.reactivePower = exports.reactiveEnergy = exports.pressure = exports.power = exports.pieces = exports.partsPer = exports.pace = exports.mass = exports.length = exports.illuminance = exports.frequency = exports.force = exports.energy = exports.each = exports.digital = exports.current = exports.charge = exports.area = exports.apparentPower = exports.angle = exports.acceleration = void 0;
    ...
    var torque_1 = __importDefault(require("./torque"));
    exports.torque = torque_1.default;
